...
import CreateGroupSideBar from '../../Components/CreateGroupSideBar/CreateGroupSideBar'
...
export default function HomeScreen() {
  ...
  const inChatOpen = location.pathname.includes('/contact/');
  ...
  return (
    <div className='home-screen-container'>
      <div className='home-screen-body'>
        <div className={`contacts-container ${inChatOpen ? 'hidden-on-mobile' : ''}`}>
            ...
            <div className='settings-icon'>
              ...
              <button onClick={() => setActiveSidebar('profile')} className="vertical-nav-avatar-btn">
                {userProfile?.avatar ? (
                  ...
                  <div className="vertical-nav-avatar-placeholder"></div>
                )}
              </button>
          ...
          <div className="sidebar-wrapper">
            {activeSidebar === 'profile' ? (
              <ProfileSideBar onClose={() => setActiveSidebar('chats')} />
            ) : activeSidebar === 'settings' ? (
              <SettingsSideBar onClose={() => setActiveSidebar('chats')} onOpenProfile={() => setActiveSidebar('profile')} />
            ) : activeSidebar === 'create-group' ? (
              <CreateGroupSideBar onClose={() => setActiveSidebar('chats')} />
            ) : (
        ...
        <div className={`contact-detail-screen ${!inChatOpen ? 'hidden-on-mobile' : ''}`}>
          <Outlet context={{ setActiveSidebar, searchInputRef, triggerSearchHint }} />
        </div>
      </div>
      {!inChatOpen && (
